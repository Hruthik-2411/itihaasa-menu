...
const Contact = () => {
  const handleReserve = () => {
    window.open("https://www.swiggy.com/dineout", "_blank", "noopener,noreferrer");
  };

  if (!cafeInfo) {
    return null; // prevents crash if data not loaded
  }
      ...
      <div className="container">
        ...
        <div className="contact-content">
          ...
          <div className="contact-map">
            <iframe
              title="Cafe Location"
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7599.600145128859!2d83.349825!3d17.754057000000003!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a395b3a6dbc87dd%3A0x448b55d23a7289!2sBean%20Board%20-%20Vishalakshi%20Nagar%20(ITI%20HA%20ASA_Foods)!5e0!3m2!1sen!2sin!4v1772118948213!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
